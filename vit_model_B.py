...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_c=3, num_classes=1000,
        ...
        # Classifier head(s)
        self.head1 = nn.Linear(self.num_features, num_classes[0]) if num_classes[0] > 0 else nn.Identity()
        self.head2 = nn.Linear(self.num_features, num_classes[1]) if num_classes[1] > 0 else nn.Identity()
...
def vit_base_patch16_224_in21k(weights:str, freeze_layers:bool, num_classes: int = 21843, has_logits: bool = True):
    """
    ViT-Base model (ViT-B/16) from original paper (https://arxiv.org/abs/2010.11929).
