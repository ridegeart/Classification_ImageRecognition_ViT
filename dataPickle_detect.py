...
rootPic = 'C:/Users/CamyTang/FMADefect/data_source/TestPicture_2/'
projectroot = 'C:/Users/CamyTang/FMADefect/ResNet50/'
...
def imgDataClean(fileName,dataset,dstroot,typeset,datalen):
    for img in dataset:
        shutil.copyfile(rootPic+img+'/'+img, dstroot+str(fileName)+'_'+img)
